...
- If your masternode is hosted by an external operator, you may need to
  enter the BLS public key provider by your operator instead of using 
  the automatically generated key. Click **use pubkey** and enter the 
  provided pubkey instead.
...
itself. If your masternode is hosted and your operator provided you with
a BLS public key, they will enter the private key themselves. If you
generated the BLS key yourself, you may need to provide this to your
operator. If you are operating the masternode yourself, log in to your
