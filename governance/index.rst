.. meta::
   :description: The Historia governance system is funded by 10% of the block reward
   :keywords: historia, dgbb, governance, funding, voting, blockchain, development, block reward
...
The DGBB also provides a means for Historia to fund its own development.
While other projects have to depend on donations or premined endowments,
Historia uses 10% of the block reward to fund its own development. Every
...
Historia governance system, including formal analysis of weaknesses and
areas for improvement. You can view the report `here
<https://iohk.io/research/papers/#NSJ554WR>`_.

You can learn more about Historia Governance in the following sections:
